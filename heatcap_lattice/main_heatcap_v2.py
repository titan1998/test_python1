...
#intial parameters
N = 25# model ferromagnet as N by N lattice. Total lattices points is N^2
...
tstep = 600 #number of time steps used to reach near equilibrium
kb = 1 #cnst.k
...
cf1=open('./C_avg_25.out', 'w+') #Open file to write values to use for plotting
cf2=open('./C_iter_25.out', 'w+') #Open file to write values to use for plotting
cf3=open('./C_theo_25.out', 'w+') #Open file to write values to use for plotting 
